...
@section("contint")
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container position-relative">
      <h1>{{ trans("frontend/home.Welcome to Athrek") }}</h1>
      <h2>{{ trans("frontend/home.Athrtec Contracting Group works in accordance with the standards of the sustainability certificate, and the certificate is issued to the client by the Ministry of Housing.") }}</h2>
      <a href="#about" style="font-size: 22px" class="btn-get-started scrollto">{{ trans("frontend/home.services") }}</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="{{ URL::asset("frontend/assets/img/pexels-pavel-danilyuk-7869066.jpg")}}" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" style="text-align: center;margin: 40px 0px">
            <h3 style="text-align: center">{{ trans("frontend/home.about us") }}</h3>
            <p style="font-size: 22px;">
            {{ trans("frontend/home.about2") }}
            </p>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center">
          <h3>{{ trans("frontend/home.ct1") }}</h3>
          <p> {{ trans("frontend/home.ct2") }}</p>
          <a class="cta-btn" href="#">{{ trans("frontend/home.ct3") }}</a>
        </div>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container">
        ...
        <div class="section-title">
          <h2>{{ trans("frontend/home.test1") }}</h2>
          <p>{{ trans('frontend/home.test4') }}</p>
        </div>
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>{{ trans("frontend/home.Team") }}</h2>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img style="height: 250px;width: 250px" src="{{ URL::asset("frontend/assets/img/team/pexels-moose-photos-1036627.jpg")}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img" >
                <img style="height: 250px;width: 250px" src="{{ URL::asset("frontend/assets/img/team/pexels-pixabay-220453.jpg")}}" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>{{ trans('frontend/home.con1') }}</h2>
        </div>
          ...
          <div class="col">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>{{ trans('frontend/home.con2') }}</h3>
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>{{ trans('frontend/home.con3') }}</h3>
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>{{ trans('frontend/home.con4') }}</h3>
